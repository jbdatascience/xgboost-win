...
The original version can be found found in <https://github.com/dmlc/xgboost>; if you are using *nix based version, please install from the original source or just using `pip install xgboost`
